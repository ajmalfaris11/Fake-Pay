  ...
  return (
    <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center px-4 font-sans">
      ...
      <div className="text-center mb-14">
        <h1 className="text-4xl font-extrabold uppercase text-center text-[#1e40af]">Select Screenshot Type</h1>
        <p className="mb-8">Choose what you want to create.</p>
      </div>

      <button className="w-full bg-[#1e40af] text-white p-4 rounded-2xl mb-4 flex items-center justify-between text-xl font-bold">
        ...
        <p className='w-4/5'>Instant Success <br /> Page Screenshot</p>
      </button>
