...
export default function PaymentSuccessScreen() {
    return (
        <div className="max-w-sm min-h-screen bg-[#1C1C1E] text-white font-sans flex flex-col items-center relative">
            {/* Header */}
            <div className="w-full bg-[#28A745] text-center pt-5 h-[40vh] relative flex flex-col items-center ">
                ...
                <p className="text-sm text-[#d7fdab]">12 July 2025 at 02:10 PM</p>
            </div>

            {/* User Info Card */}
            <div className="w-full p-5 absolute top-[21vh]">
                <div className="w-full bg-[#2C2C2E] rounded-xl p-4 flex flex-col space-y-4 mb-4 ">
                    <div className="flex flex-col items-center justify-between">
                        <div className="flex items-start justify-start w-full ">
                            <div className="w-16 h-16 bg-[#27b4fc] rounded-3xl flex items-center justify-center text-2xl mr-4">
                                FF
                            </div>
                    ...
                    <div className="flex items-center mt-2 border-t-[1px] border-gray-800 pt-4 justify-between">
                        <button className="flex items-center text-sm text-white gap-2 border-r-[1px] border-gray-800 w-[50%]">
                            <div className="bg-[#853cd8] bg-opacity-30 p-3 rounded-full w-[40px] h-[40px] flex items-center justify-center text-[#853cd8]">
